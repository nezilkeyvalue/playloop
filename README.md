...
several rounds of real design polish. Four game templates (`catch`,
`guess_price`, `chain_pop`, `shooter`) are fully implemented end-to-end;
`match`/`stack` are reserved in the type system for future templates (see
